...
def main():
    def setup_player():
        ...
        user = {'name': user_name, 'health': 10, 'inventory': []}
    ...
    def search_room(player, treasures):
        ...
        # TODO: Print messages describing what happened
            print(f"You found a {treasure_name}!")
        else:
            player["health"] -= 2 
            print("You encountered a trap! Lost 2 health")
    ...
    def end_game(player, treasures):
        ...
        print(f"Inventory: {', '.join(player['inventory']) if player['inventory'] else 'None'}")
    ...
    def run_game_loop(player, treasures):
        ...
        print("You've explored all rooms!")
        end_game(player, treasures)
